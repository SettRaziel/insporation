...
repo_url = "https://jhass.github.io/insporation/fdroid/repo"
repo_name = "insporation* Repository"
repo_icon = "icon.png"
repo_description = """
...
archive_older = 3
archive_url = "https://jhass.github.io/insporation/fdroid/archive"
archive_name = "insporation* Archive"
...
# in text files!
keystorepass = os.getenv("KEYSTORE_PASSWORD")
...
keypass = os.getenv("KEYSTORE_PASSWORD")

# The distinguished name used for all keys.
keydname = "CN=Jonne Haß, OU=insporation developers, O=open source developers, L=The internet, ST=The world, C=UN"
